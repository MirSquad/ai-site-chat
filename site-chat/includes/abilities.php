...
/**
 * Register the "AI Site Chat" ability category.
 *
 * @return void
 */
...
/**
 * Register the AI Site Chat abilities (get-settings, get-logs, update-settings).
 *
 * @return void
 */
		...
		array(
			...
			'output_schema'       => array(
				...
				'properties' => array(
					...
					'api_key'             => array(
						'type'        => 'string',
						'description' => 'Masked API key (last 4 chars only).',
					),
					'rate_limit'          => array(
						'type'        => 'integer',
						'description' => 'Max chats per IP per day.',
					),
		...
		array(
			...
			'input_schema'        => array(
				...
				'properties' => array(
					'enabled'             => array(
						'type'        => 'boolean',
						'description' => 'Enable or disable the chat widget.',
					),
					'rate_limit'          => array(
						'type'        => 'integer',
						'minimum'     => 1,
					...
					'custom_instructions' => array(
						'type'        => 'string',
						'description' => 'Custom system prompt instructions. Max 2000 characters.',
					),
					'log_enabled'         => array(
						'type'        => 'boolean',
						'description' => 'Enable or disable conversation logging.',
					),
					'contact_url'         => array(
						'type'        => 'string',
						'description' => 'URL for the Contact follow-up CTA.',
					),
					'newsletter_url'      => array(
						'type'        => 'string',
						'description' => 'URL for the Newsletter follow-up CTA.',
					),
				),
			),
			'output_schema'       => array(
